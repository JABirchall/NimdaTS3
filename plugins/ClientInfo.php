...
class ClientInfo extends Plugin implements PluginContract
{
    ...
    public function isTriggered()
    {
        ...
        try {
            ...
            $this->sendOutput("[COLOR=blue][B]%s: Joined: %s", $name, Carbon::createFromTimestamp($clientInfo["client_created"])->toDateTimeString());
            $this->sendOutput("[COLOR=blue][B]%s: Last connection: %s", $name, Carbon::createFromTimestamp($clientInfo["client_lastconnected"])->toDateTimeString());
